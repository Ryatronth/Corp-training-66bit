...
CREATE SEQUENCE IF NOT EXISTS public.sequence_id_auto_gen
    INCREMENT BY 15
    MINVALUE 1
    MAXVALUE 9223372036854775807
    START 1
    CACHE 15
    NO CYCLE;
-- DROP SEQUENCE public.topic_t_id_seq;
...
(
    id                int8         NOT NULL,
    completed_modules int4         NOT NULL,
...
(
    id               int8 GENERATED BY DEFAULT AS IDENTITY ( INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL,
    completed_topics int4                                                                                                                     NOT NULL,
    current_score    int4                                                                                                                     NOT NULL,
    is_completed     bool                                                                                                                     NOT NULL,
    course_id        int8                                                                                                                     NULL,
    module_id        int8                                                                                                                     NULL,
...
(
    id                 int8 GENERATED BY DEFAULT AS IDENTITY ( INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL,
    completed_contents int4                                                                                                                     NOT NULL,
    current_score      int4                                                                                                                     NOT NULL,
    is_completed       bool                                                                                                                     NOT NULL,
    module_id          int8                                                                                                                     NULL,
    topic_id           int8                                                                                                                     NULL,
